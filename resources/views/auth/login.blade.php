...
<head>
    ...
    <title>PT. SEPATU BATA TBK PURWAKARTA</title>
                            ...
                            <div class="col-lg-20">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">PT. SEPATU BATA TBK<br>CABANG PURWAKARTA<br>
                                            <br><img src="{{ asset('asset/img/bata2.png')}}" width="200">
                                        </h1>
                                    </div>
