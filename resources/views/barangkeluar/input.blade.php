    ...
    <form action="{{ route('barangkeluar.store') }}" method="POST">
        ...
        <fieldset>
            <div class="form-group row">
                <div class="col-md-5">
                    Nomor Transaksi
                    <input id="notran" type="text" name="notrans" class="form-control" value="{{ $nomor }}" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-5">
            ...
            <div class="form-group row">
                <div class="col-md-10">
                    Nama Customer
                    <textarea id="nmcsbk" type="text" name="nmcsbk" class="form-control" required></textarea>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-5">
