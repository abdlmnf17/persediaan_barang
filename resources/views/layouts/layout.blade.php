        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="asset/img/bata2.png" width="60">
                </div>
                <div class="sidebar-brand-text mx-2">PT. SEPATU BATA TBK</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{route('persediaan.index')}}"> Lihat Stok Barang</a>
                    </div>
                </div>
            </li>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <h4>PT. SEPATU BATA TBK (PURWAKARTA)</h4>
                            </div>
                        </div>
                    </form>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: Kelompok2<br>Copyright &copy; KelompokDua2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
